...
namespace QBDIntegrationWorker.QuickBooksLibrary
{
    ...
    internal class QbAuthorizationController
    {
            ...
            string realmId, IntuitServicesType serviceType)
        {
            ...
            context = new ServiceContext(oauthValidator, realmId, serviceType);
            return context;
        }
        ...
        /// <returns>service context for integrating with the company built in the context</returns>
        internal static ServiceContext InitializeServiceContext(OAuthRequestValidator oauthValidator,
            string appToken, string realmId, IntuitServicesType serviceType)
        {
            ServiceContext context = new ServiceContext(oauthValidator, appToken, realmId, serviceType);
            return context;
        }
    }
}
